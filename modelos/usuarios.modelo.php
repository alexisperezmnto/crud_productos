...
class ModeloUsuarios{
	...
	static public function mdlRegistrarUsuario($tabla, $datos) {
		$stmt = Conexion::conectar() -> prepare("INSERT INTO $tabla(nombre,email,usuario,password,perfil,foto,estado)	
            VALUES (:nombre, :email, :usuario, :password, :perfil, :foto, 1)");
	...
	static public function mdlEditarUsuario($tabla, $datos) {
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, email = :email,
            usuario = :usuario, password = :password, perfil = :perfil, foto = :foto WHERE id = :id");
	...
	static public function mdlEditarPerfilUsuario($tabla, $datos) {
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, email = :email,
            usuario = :usuario, password = :password, foto = :foto WHERE id = :id");
